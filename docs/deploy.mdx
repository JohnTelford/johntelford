...
Cloudflare builds websites and deploys them when [VScode](vscode.md) pushes changes from the _Local Repository_ to the _Central Repository_, Cloudflare then automatically builds the website and deploys to the Internet.
